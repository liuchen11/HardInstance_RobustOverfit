...
def svhn(batch_size, valid_ratio = None, shuffle = True, train_subset = None):

    transform = transforms.Compose([
        transforms.ToTensor(),
        ])

    trainset = IndexedSVHN(root = './data/svhn', split = 'train', download = True, transform = transform)
    validset = IndexedSVHN(root = './data/svhn', split = 'train', download = True, transform = transform)
...
def svhn_plus(batch_size, plus_prop, valid_ratio, train_subset = None):
    ...
    trainset = IndexedSVHN_Plus(root4ori = './data/svhn', root4plus = './extradata/svhn', split = 'train', download = True, transform = transform)
    validset = IndexedSVHN_Plus(root4ori = './data/svhn', root4plus = './extradata/svhn', split = 'train', download = True, transform = transform)
    testset = IndexedSVHN(root = './data/svhn', split = 'test', download = True, transform = transform)
